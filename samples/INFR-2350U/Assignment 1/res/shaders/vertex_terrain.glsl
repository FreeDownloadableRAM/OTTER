...
void main() {
	...
	outTexWeights = vec4(
		...
		max(GetTextureWeight(height, lowerEdge.y, upperEdge.y), GetTextureWeight(height, upperEdge.z, lowerEdge.z)),
	...
	*/
	...
	/* 
	outTexWeights = vec4(
		GetTextureWeight(height, upperEdge.y, lowerEdge.y),
		min(GetTextureWeight(height, lowerEdge.y, upperEdge.y), GetTextureWeight(height, upperEdge.z, lowerEdge.z)),
		max(GetTextureWeight(height, lowerEdge.z, upperEdge.z), GetTextureWeight(height, upperEdge.x, lowerEdge.x)),
		GetTextureWeight(height, lowerEdge.x, upperEdge.x)
